...
Instruções para uso:
1) O usuário deverá inserir o comando 'dart run' após acessar a pasta do projeto.
2) O programa irá ser inicializado e o usuário deverá prosseguir inserindo uma das opções apresentadas pelo programa.